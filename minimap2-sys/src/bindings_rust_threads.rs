...
pub const ZLIB_VERSION: &::std::ffi::CStr =
    unsafe { ::std::ffi::CStr::from_bytes_with_nul_unchecked(b"1.3\0") };
...
pub const MM_VERSION: &::std::ffi::CStr =
    unsafe { ::std::ffi::CStr::from_bytes_with_nul_unchecked(b"2.28-r1209\0") };
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of mm_mapopt_t"][::std::mem::size_of::<mm_mapopt_t>() - 256usize];
    ...
    ["Offset of field: mm_mapopt_t::zdrop"][::std::mem::offset_of!(mm_mapopt_t, zdrop) - 140usize];
    ["Offset of field: mm_mapopt_t::zdrop_inv"]
        [::std::mem::offset_of!(mm_mapopt_t, zdrop_inv) - 144usize];
    ["Offset of field: mm_mapopt_t::end_bonus"]
        [::std::mem::offset_of!(mm_mapopt_t, end_bonus) - 148usize];
    ["Offset of field: mm_mapopt_t::min_dp_max"]
        [::std::mem::offset_of!(mm_mapopt_t, min_dp_max) - 152usize];
    ["Offset of field: mm_mapopt_t::min_ksw_len"]
        [::std::mem::offset_of!(mm_mapopt_t, min_ksw_len) - 156usize];
    ["Offset of field: mm_mapopt_t::anchor_ext_len"]
        [::std::mem::offset_of!(mm_mapopt_t, anchor_ext_len) - 160usize];
    ["Offset of field: mm_mapopt_t::anchor_ext_shift"]
        [::std::mem::offset_of!(mm_mapopt_t, anchor_ext_shift) - 164usize];
    ["Offset of field: mm_mapopt_t::max_clip_ratio"]
        [::std::mem::offset_of!(mm_mapopt_t, max_clip_ratio) - 168usize];
    ["Offset of field: mm_mapopt_t::rank_min_len"]
        [::std::mem::offset_of!(mm_mapopt_t, rank_min_len) - 172usize];
    ["Offset of field: mm_mapopt_t::rank_frac"]
        [::std::mem::offset_of!(mm_mapopt_t, rank_frac) - 176usize];
    ["Offset of field: mm_mapopt_t::pe_ori"]
        [::std::mem::offset_of!(mm_mapopt_t, pe_ori) - 180usize];
    ["Offset of field: mm_mapopt_t::pe_bonus"]
        [::std::mem::offset_of!(mm_mapopt_t, pe_bonus) - 184usize];
    ["Offset of field: mm_mapopt_t::mid_occ_frac"]
        [::std::mem::offset_of!(mm_mapopt_t, mid_occ_frac) - 188usize];
    ["Offset of field: mm_mapopt_t::q_occ_frac"]
        [::std::mem::offset_of!(mm_mapopt_t, q_occ_frac) - 192usize];
    ["Offset of field: mm_mapopt_t::min_mid_occ"]
        [::std::mem::offset_of!(mm_mapopt_t, min_mid_occ) - 196usize];
    ["Offset of field: mm_mapopt_t::max_mid_occ"]
        [::std::mem::offset_of!(mm_mapopt_t, max_mid_occ) - 200usize];
    ["Offset of field: mm_mapopt_t::mid_occ"]
        [::std::mem::offset_of!(mm_mapopt_t, mid_occ) - 204usize];
    ["Offset of field: mm_mapopt_t::max_occ"]
        [::std::mem::offset_of!(mm_mapopt_t, max_occ) - 208usize];
    ["Offset of field: mm_mapopt_t::max_max_occ"]
        [::std::mem::offset_of!(mm_mapopt_t, max_max_occ) - 212usize];
    ["Offset of field: mm_mapopt_t::occ_dist"]
        [::std::mem::offset_of!(mm_mapopt_t, occ_dist) - 216usize];
    ["Offset of field: mm_mapopt_t::mini_batch_size"]
        [::std::mem::offset_of!(mm_mapopt_t, mini_batch_size) - 224usize];
    ["Offset of field: mm_mapopt_t::max_sw_mat"]
        [::std::mem::offset_of!(mm_mapopt_t, max_sw_mat) - 232usize];
    ["Offset of field: mm_mapopt_t::cap_kalloc"]
        [::std::mem::offset_of!(mm_mapopt_t, cap_kalloc) - 240usize];
    ["Offset of field: mm_mapopt_t::split_prefix"]
        [::std::mem::offset_of!(mm_mapopt_t, split_prefix) - 248usize];
};
#[repr(C)]
#[derive(Copy, Clone)]
